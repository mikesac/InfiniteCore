...
public class AreaItem implements java.io.Serializable {
	...
	public AreaItem(String name, String icon, Integer cost, Integer areaid,
			...
			Integer areatype, String questlock, String url, boolean doublestep,
			boolean hidemode, Integer level, String npcs) {
		this.name = name;
		this.icon = icon;
		this.cost = cost;
		this.areaid = areaid;
	...
	public AreaItem(String name, String icon, Integer cost, Integer areaid,
			short areax, short areay, Integer x, Integer y, String arealock,
			Integer areatype, String questlock, String url, boolean doublestep,
			boolean hidemode, Integer level, String npcs, Set<Player> players) {
		this.name = name;
		this.icon = icon;
		this.cost = cost;
		this.areaid = areaid;
