...
public class Item implements java.io.Serializable {
	...
	private Set<Quest> questsForGoalItem = new HashSet<Quest>(0);
	private Set<Quest> questsForGrantItem = new HashSet<Quest>(0);

	public Item() {
	}

	public Item(String name, String description, String image, Integer costAp,
			Integer reqStr, Integer reqInt, Integer reqDex, Integer reqCha,
			Integer reqLev, Integer modStr, Integer modInt, Integer modDex,
			Integer modCha, float price, Integer level, Integer spell,
	...
	public Item(String name, String description, String image, Integer costAp,
			...
			Set<Quest> questsForGoalItem, Set<Quest> questsForGrantItem) {
		this.name = name;
		this.description = description;
		this.image = image;
		this.costAp = costAp;
		...
		this.questsForGoalItem = questsForGoalItem;
		this.questsForGrantItem = questsForGrantItem;
	}
	...
	public Set<Quest> getQuestsForGoalItem() {
		return this.questsForGoalItem;
	}

	public void setQuestsForGoalItem(Set<Quest> questsForGoalItem) {
		this.questsForGoalItem = questsForGoalItem;
	}

	public Set<Quest> getQuestsForGrantItem() {
		return this.questsForGrantItem;
	}

	public void setQuestsForGrantItem(Set<Quest> questsForGrantItem) {
		this.questsForGrantItem = questsForGrantItem;
	}
