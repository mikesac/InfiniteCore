...
public final class GenericUtil {
	...
	/**
	 * roll a percentage probability dice
	 * @param threshold
	...
	public static int rollDice(String diceType) throws Exception{

		String szDiceType = diceType.toLowerCase().trim();
	...
	public static int getMaxRollDice(String diceType){
	...
	public static int getMinRollDice(String diceType){
	...
	private static int[] splitValues(String diceType) throws Exception {
	...
	public static Integer forceBetween(int points, int min, int max) {
		return Math.min( Math.max(points, min), max);
	}
