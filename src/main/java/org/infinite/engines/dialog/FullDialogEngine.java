...
public final class FullDialogEngine {

	protected static final String S = "sentence.";
	protected static final String A = "answer.";

	public static final String TOPARSE = "TOPARSE";
	
	
	private FullDialogEngine(){}
	...
	protected static String parsePagesCST(String input){

		String myinput = input;
		
		if( myinput.startsWith(TOPARSE) ){

			myinput = myinput.substring(7);
